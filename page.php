...
<body>
    ...
    <div class="container-fluid link-row">
        <div class="container">
            <div class="col-md-12">
                <h2>Page Blank</h2>
                <div class="link-sec"> <a href="#">Home</a> &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i> &nbsp; <a href="#">Page Blank</a> </div>
            </div>
    ...
    <div class="container top-sec">
      ...
      <div class="article-img wow animated fadeInDown"><img src="assests/img/blog/blog-1.jpg" alt="" class="img-responsive" /></div>
            ...
            <div class="col-md-offset-0 col-md-3 padd-60 padd-btn-none">
                <!--left-sec-->
            </div>
            <div class="clearfix"></div>
        </div>
