...
<div class="container top-sec"><!--main-container-->
    <div class="row"><!--row-->
        ...
        <div class="col-md-9 padd-60 slider"><!--right-sec-->
            ...
            <!--main-slider-->
            <div id="carousel-example-generic" class="carousel slide grid-slider" data-ride="carousel" dir="ltr">
                ...
                <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev"> <span
                            class="glyphicon-chevron-left" aria-hidden="true"><i class="fa fa-chevron-left"
