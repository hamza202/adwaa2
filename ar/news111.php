...
<div class="container-fluid link-row">
  <div class="container">
    <div class="col-md-12">
      <h2>Blog</h2>
      <div class="link-sec"> <a href="#">Home</a> &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i> &nbsp; <a href="#">Blog</a> </div>
    </div>
...
إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع. </p>
    ...
    <div class="divider"></div>
    <div class="pull-right"> <a class="prev mar-prev-right" href="#">PREV</a> <a href="#" class="pagination-page">1</a> <a href="#" class="pagination-page">2</a> <a href="#">NEXT</a> </div>
    <div class="clearfix"></div>
            ...
            <div class="row categories">
                <ul>
                    <li class="sub-menu"><a class="main-a" href="javascript:void(0)">CATEGORIES <i class='fa fa-angle-down'></i></a>
                        <ul>
                            <li><a href="page.php">About Us</a>
                            </li>
                            <li><a href="page.php">Join Our Mailing List</a>
                            </li>
                            <li><a href="products.php">Product Categories</a>
                            </li>
